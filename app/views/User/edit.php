      ...
      <form action='' method='post'>
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" name="user_address" placeholder="Enter your email" required>
          </div>
          <div class="input-box">
            <span class="details">City</span>
            <input type="text" name="user_city" placeholder="Enter your email" required>
          </div>
          <div class="input-box">
            <span class="details">Country</span>
            <input type="text" name="user_country" placeholder="Enter your email" required>
          </div>
          <div class="input-box">
            <span class="details">Region</span>
            <input type="text" name="user_region" placeholder="Enter your email" required>
          </div>
          <div class="input-box">
            <span class="details">Postal Code</span>
            <input type="text" name="user_zip" placeholder="Enter your email" required>
          </div>
        </div>
        <div class="button">
