...
class User extends \app\core\Model{
	...
	public function update(){
		$SQL = "UPDATE user SET user_fname=:user_fname, user_lname=:user_lname, user_email=:user_email, user_phone=:user_phone, user_address=:user_address, user_city=:user_city, user_country=:user_country, user_region=:user_region, user_zip=:user_zip WHERE user_id=:user_id";
		$STMT = self::$_connection->prepare($SQL);
		$STMT->execute(['user_fname'=>$this->user_fname,
						'user_lname'=>$this->user_lname,
						'user_email'=>$this->user_email,
						'user_phone'=>$this->user_phone,
						'user_address'=>$this->user_address,
